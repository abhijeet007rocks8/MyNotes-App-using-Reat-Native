...
//lodsh is used for converting the coming object data into list data
...
const NotesScreenComponent = () => {
    ...
    //data is the state thta changed to render the notes in the screen
    //setdata should refer to firebase and data coming form there
    ...
    useEffect(()=>{firebase.database().ref(`/user/${loggedInUserID}/`)
    ...
    //This function called everytime there is a change in data
//completeNewdata.val() .val() converts the datasnapshot to javascript object
